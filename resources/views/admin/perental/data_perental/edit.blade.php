                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical"
                                    action="{{ route('perentalUpdate', $perental->id_perental) }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 ">
                                                ...
                                                <div class="form-floating">
                                                    <textarea class="form-control mt-2" placeholder="Masukkan Keterangan Disini" id="keterangan" name="keterangan">{{ $perental->keterangan }}</textarea>
                                                    <label for="keterangan">Masukkan Keterangan Disini</label>
                                                </div>
                                            </div>
                                            <div class="col-12 mt-3">
                                                <div class="form-group">
                                                    <label for="status_perental" class="mb-2">Status Perental <sup
                                                            class="text-danger">*</sup></label>
                                                    <select class="choices form-select" id="status_perental"
                                                        name="status_perental" required>
