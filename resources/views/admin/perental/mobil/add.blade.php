                ...
                <div class="col-md-9 col-12 mt-4">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" action="{{ route('mobilStore') }}" method="POST"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="jenis_mobil" class="form-control mt-2"
                                                        ...
                                                        value="{{ old('jenis_mobil') }}" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="Pengisian maksimal hanya 25 karakter" />
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12 mt-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" id="tanggal_didaftarkan" class="form-control mt-2"
                                                        min="2019-01-01" name="tanggal_didaftarkan" required
                                                        max="2300-01-01" value="{{ old('tanggal_didaftarkan') }}" />
                                                </div>
                                            </div>
                                            <div class="col-12 mt-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="harga" class="form-control mt-2"
                                                        ...
                                                        autocomplete="transaction-currency" value="{{ old('harga') }}" />
                                                </div>
                                            </div>
                                            <div class="col-12 mt-2">
                                                ...
                                                <div class="form-floating">
                                                    <textarea class="form-control mt-2" placeholder="Masukkan Deskripsi Mobil Disini" id="deskripsi_mobil"
                                                        name="deskripsi_mobil" data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Kolom Deskripsi ini bisa dipanjangkan ukuran wadahnya, apabila dirasa tampilan default kurang memadai saat penambahan data pada kolom ini">{{ old('deskripsi_mobil') }}</textarea>
                                                    <label for="deskripsi_mobil">Masukkan Deskripsi Mobil Disini</label>
                                                </div>
                                            </div>
                                            <div class="col-12 mt-3">
                                                <div class="form-group">
                                                    <label for="foto_mobil">Foto Mobil <sup
                                                            class="text-danger">*</sup></label>
                                                    <input type="file" id="foto_mobil"
                                                        class="form-control mt-2 image-preview-filepond" name="foto_mobil"
                                                        required value="{{ old('foto_mobil') }}" accept="image/*"  />
                                                </div>
                                            </div>
