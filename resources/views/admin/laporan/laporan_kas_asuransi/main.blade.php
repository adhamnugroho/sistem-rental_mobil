            ...
            <div class="card-body">
                <div class="row mb-n2 justify-content-end">
                    ...
                    <div class="col-2 d-flex ms-n2 justify-content-end">
                        <button type="submit" class="btn btn-primary ps-3 pe-3" onclick="cariDataKasAsuransi()"
                            id="tombol_cari">
                    ...
                    <tbody>
                        @foreach ($laporan_kas_asuransi as $key => $lka)
                            <tr>
                                ...
                                <td class="ps-4">{{ $lka->total_keuangan_asuransi_semua }}</td>
...
@section('script')
    ...
    <script>
        ...
        // $('#search').on('keyup', cariDataKasAsuransi);

        // // Jquery saat event tombol x input:search diklik
        // $('#search').on('search.dt', cariDataKasAsuransi);


        function cariDataKasAsuransi() {
            ...
            const hasil_route = route('laporanKasAsuransi', {
                tanggal_awal,
                tanggal_akhir
            });
    ...
    <script>
        function print(event) {
            ...
            const hasil_routeCariData = route('laporanKasAsuransiCariData');
            const hasil_routePrint = route('laporanKasAsuransiPrint', {
                tanggal_awal,
                tanggal_akhir
            });
