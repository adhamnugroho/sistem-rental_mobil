                ...
                <div class="col-md-9 col-12 mt-4">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" action="{{ route('keuanganAdminKurangStore') }}"
                                    method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="kas_admin_keluar" class="mb-2">Nominal Pengeluaran <sup
                                                            class="text-danger">*</sup></label>
                                                    <input type="number" id="kas_admin_keluar" class="form-control mt-2"
                                                        name="kas_admin_keluar" min="100"
                                                        placeholder="Masukkan Nominal Pengeluaran Kas Admin" required
                                                        inputmode="numeric" autocomplete="transaction-currency"
                                                        value="{{ old('kas_admin_keluar') }}" />
                                                </div>
                                            </div>
