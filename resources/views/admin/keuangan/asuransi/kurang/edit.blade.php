            ...
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        Harap memasukkan data pengeluaran {{ $judul }} dengan benar.
                    </p>
                </div>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical"
                                    action="{{ route('keuanganAsuransiKurangUpdate', $kas_asuransi->id_kas_asuransi) }}"
                                    method="POST">
                                                ...
                                                <div class="col-12 mt-2">
                                                    <div class="form-group">
                                                        <label for="kas_asuransi_keluar" class="mb-2">Nominal Keuangan
                                                            Asuransi
                                                            Keluar <sup class="text-danger">*</sup></label>
