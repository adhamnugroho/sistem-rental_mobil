            ...
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        Harap memasukkan data pengeluaran {{ str_replace('_', ' ', $judul) }} dengan benar.
                    </p>
                </div>
                    ...
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                Kurang Saldo {{ str_replace('_', ' ', $judul) }}
                            </li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="col-md-9 col-12 mt-4">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Form Pengeluaran {{ str_replace('_', ' ', $judul) }}</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" action="{{ route('keuanganAsuransiKurangStore') }}"
                                    method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="kas_asuransi_keluar" class="mb-2">Nominal Pengeluaran <sup
                                                            class="text-danger">*</sup></label>
                                                    <input type="number" id="kas_asuransi_keluar" class="form-control mt-2"
                                                        name="kas_asuransi_keluar" min="100"
                                                        placeholder="Masukkan Nominal Pengeluaran Kas Asuransi" required
                                                        inputmode="numeric" autocomplete="transaction-currency"
                                                        value="{{ old('kas_asuransi_keluar') }}" />
                                                </div>
                                            </div>
                                            <div class="col-12 mt-2">
                                                <div class="form-group">
                                                    <label for="tanggal">
                                                        Tanggal Pengeluaran <sup class="text-danger">*</sup>
                                                    </label>
