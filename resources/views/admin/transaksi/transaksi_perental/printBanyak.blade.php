                        ...
                        <div class="row mt-5">
                            <div class="col-xl-12">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="text-muted">Nama Perental: <span
                                            style="color:#5d9fc5 ;">{{ $nama_perental }}</span>
                                    </li>
                                    <li class="text-muted">Tempat Penyewaan: <span
                                            style="color:#5d9fc5 ;">{{ $tempat_penyewaan }}</span>
                                    </li>
                            ...
                            <div class="col-xl-12">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="text-muted"></i>
                                        <span class="me-1">Status Pembayaran Perentalan:</span><span
                            ...
                            <table class="table table-striped">
                                <thead class="table-active">
                                    <tr class="text-dark fw-bold">
                                        <th class="text-center" scope="col">Nama Penyewa</th>
                                ...
                                <tbody>
                                    @foreach ($penyewa as $pny)
                                        <tr>
                                            <td>
                                                {{ $pny->users->nama_lengkap }}
                                            </td>
                                            <td>{{ $pny->penyewa_detail[0]->mobil->jenis_mobil }}</td>
                                            <td>{{ $pny->penyewa_detail[0]->mobil->plat_nomor }}</td>
                                            <td>{{ $pny->penyewa_detail[0]->mobil->harga }}</td>
                                            <td>{{ $pny->penyewa_detail[0]->tanggal_penyewaan }}</td>
                                            <td>{{ $pny->penyewa_detail[0]->tanggal_pengembalian }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            ...
                            <div class="col-xl-12 mt-2">
                                <ul class="list-unstyled">
                                    <li class="text-muted ms-3">
                                        <span class="text-black me-4">Total Harga Semua
                                            Penyewaan:</span>Rp. {{ $total_harga }}
                                    </li>
                                    <li class="text-muted ms-3 mt-2"><span class="text-black me-4">Kas
                                            Asuransi(2%): </span>Rp.
                                        {{ $total_kas_asuransi_masuk }}
                                    </li>
                                    <li class="text-muted ms-3 mt-2"><span class="text-black me-4">Kas
                                            Admin(1%): </span>Rp. {{ $total_kas_admin_masuk }}
                                    </li>
                                ...
                                <ul class="list-unstyled">
                                    <li class="text-muted ms-3">
                                        <span class="text-black me-4">Uang Bersih Perental: </span>Rp.
