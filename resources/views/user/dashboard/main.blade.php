...
@section('content')
    <div class="hero-wrap ftco-degree-bg" style="background-image: url('{{ asset('template-user/images/bg_1.jpg') }}');"
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-12 d-flex align-items-center">
                            <div class="services-wrap rounded-right w-100">
                                ...
                                <p><a href="#mobil_unggulan" class="btn btn-primary py-3 px-4">Reserve Your Perfect Car</a>
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <section class="ftco-section ftco-no-pt bg-light" id="mobil_unggulan">
        <div class="container">
                            ...
                            <div class="item">
                                <div class="car-wrap rounded ftco-animate">
                                    <div class="img rounded d-flex align-items-end"
                                        style="background-image: url({{ asset('/storage/' . $mb->foto_mobil) }});">
                                    </div>
                                    <div class="text">
                                        <h2 class="mb-0"><a href="#">{{ $mb->jenis_mobil }}</a></h2>
                                        <div class="d-flex mb-3 mt-2">
                                            <span class="cat">{{ $mb->warna }}</span>
                                            <p class="price ml-auto">Rp. {{ number_format($mb->harga, 0, ',', '.') }}
                                                <span>/hari</span>
                                            </p>
                                        </div>
                                        <p class="d-flex mb-0 d-block">
                                            <a href="{{ route('userPenyewaan', $mb->id_mobil) }}"
                                                class="btn btn-primary py-2 mr-1">Pesan
                                            </a>
                                            {{-- <a href="{{ route('userDetailMobil', $mb->id_mobil) }}"
                                                class="btn btn-secondary py-2 ml-1">Detail
                                            </a> --}}
                                        </p>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="row no-gutters">
                <div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center"
                    style="background-image: url({{ asset('template-user/images/about.jpg') }});">
                </div>
                <div class="col-md-6 wrap-about ftco-animate">
                    <div class="heading-section heading-section-white pl-md-5">
                        <span class="subheading">About us</span>
                        <h2 class="mb-4">Welcome to TransportIn</h2>
                        ...
                        <p>On her way she met a copy. The copy warned the Little Blind Text, that where it came from it
                            ...
                            into your mouth.</p>
                        <p><a href="#mobil_unggulan" class="btn btn-primary py-3 px-4">Search Vehicle</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="ftco-section ftco-intro" style="background-image: url({{ asset('template-user/images/bg_3.jpg') }});">
        <div class="overlay"></div>
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row d-flex">
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry justify-content-end">
                        <a href="blog-single.html" class="block-20"
                            style="background-image: url('{{ asset('template-user/images/image_1.jpg') }}');">
                        </a>
                        <div class="text pt-4">
                            <div class="meta mb-3">
                ...
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry justify-content-end">
                        <a href="blog-single.html" class="block-20"
                            style="background-image: url('{{ asset('template-user/images/image_2.jpg') }}');">
                        </a>
                        <div class="text pt-4">
                            <div class="meta mb-3">
                                <div><a href="#">Oct. 29, 2019</a></div>
                ...
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry">
                        <a href="blog-single.html" class="block-20"
                            style="background-image: url('{{ asset('template-user/images/image_3.jpg') }}');">
                        </a>
                        <div class="text pt-4">
                            <div class="meta mb-3">
                                <div><a href="#">Oct. 29, 2019</a></div>
