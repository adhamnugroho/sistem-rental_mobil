...
@section('content')
    <section class="hero-wrap hero-wrap-2 js-fullheight"
        style="background-image: url({{ asset('template-user/images/bg_3.jpg') }});" data-stellar-background-ratio="0.5">
                ...
                <div class="col-md-12">
                    <div class="car-details">
                        <div class="img rounded"
                            style="background-image: url({{ asset('template-user/images/bg_1.jpg') }});"></div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="car-wrap rounded ftco-animate">
                        <div class="img rounded d-flex align-items-end"
                            style="background-image: url({{ asset('template-user/images/car-1.jpg') }});">
                        </div>
                        <div class="text">
                ...
                <div class="col-md-4">
                    <div class="car-wrap rounded ftco-animate">
                        <div class="img rounded d-flex align-items-end"
                            style="background-image: url({{ asset('template-user/images/car-2.jpg') }});">
                        </div>
                        <div class="text">
                ...
                <div class="col-md-4">
                    <div class="car-wrap rounded ftco-animate">
                        <div class="img rounded d-flex align-items-end"
                            style="background-image: url({{ asset('template-user/images/car-3.jpg') }});">
                        </div>
                        <div class="text">
                            <h2 class="mb-0"><a href="car-single.html">Mercedes Grand Sedan</a></h2>
                            <div class="d-flex mb-3">
